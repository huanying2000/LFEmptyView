...
- (void)setupSubViews {
    ...
    subViewMargin = self.subViewMargin ? self.subViewMargin : kSubViewMargin;
    //占位图片
...
- (void)setSubViewFrame{
    ...
    self.lf_size = CGSizeMake(contentWidth, contentHeight);
...
- (void)setupPromptImageView:(UIImage *)img {
    ...
    contentWidth = self.promptImageView.lf_size.width;
...
- (void)setupTitleLabel:(NSString *)titleStr {
    ...
    //contentHeight 图片高度
    self.titleLabel.frame = CGRectMake(0, contentHeight + subViewMargin, width, fontSize);
...
- (void)setupDetailLabel:(NSString *)detailStr{
    ...
    self.detailLabel.frame = CGRectMake(0, contentHeight + subViewMargin, width, height);
...
- (void)setupActionBtn:(NSString *)btnTitle target:(id)target action:(SEL)action btnClickBlock:(LFActionTapBlock)btnClickBlock{
    ...
    self.actionButton.frame = CGRectMake(0, contentHeight + subViewMargin, btnWidth, btnHeight);
